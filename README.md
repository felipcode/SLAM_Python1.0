...
This is just a mapping Algorithm. It simulates a LiDAR sensor; has a sensing logic; stores PointCloud data; creates visualization os the data points stored on local memory
